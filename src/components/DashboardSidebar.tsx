...
const DashboardSidebar = ({ isOpen }: DashboardSidebarProps) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 z-40 h-screen bg-white border-r border-gray-200 transition-all duration-300 ${isOpen ? 'w-64' : 'w-0 -translate-x-full lg:translate-x-0 lg:w-16'
      }`}>
