      ...
      <div className="relative max-w-5xl mx-auto py-12 px-4 space-y-16">
        ...
        >
          <div className="inline-block mb-2 relative">
            <Badge variant="secondary" className="px-6 py-1.5 text-base bg-gradient-to-r from-primary/80 to-primary text-white">
              <span className="mr-2">✦</span> BridgeEasy <span className="ml-2">✦</span>
            </Badge>
          ...
          <p className="text-xl md:text-2xl text-purple-700 max-w-3xl mx-auto leading-relaxed">
            Welcome, <span className="font-semibold text-purple-900 border-b-2 border-purple-300">{user?.displayName || 'Valued Client'}</span>!
...
const PremiumFeatureCard = ({ icon, title, description, highlight = false }) => {
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-xl ${highlight
    ...
    >
      ...
      <div className={`rounded-full w-16 h-16 flex items-center justify-center mb-6 ${highlight
